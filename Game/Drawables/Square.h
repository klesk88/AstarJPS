...
public:
	...
	void InitList(const std::vector<int>& indexes, const CGrid& rGrid, const DirectX::SimpleMath::Color color, const float fUpOffset = 0.1f, const bool bAddToUpdateList = true);
